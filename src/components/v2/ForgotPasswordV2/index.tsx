        ...
        return (
            <div className="relative flex min-h-screen w-full flex-col bg-gray-50 dark:bg-slate-950 overflow-x-hidden">
                ...
                <div className="flex flex-col px-6 pt-8 pb-4 max-w-md mx-auto w-full items-center text-center">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-base font-normal leading-normal pb-2">
                        Enviamos um link de recuperação para <strong className="text-slate-700 dark:text-slate-300">{email}</strong>.
                    </p>
                    <p className="text-slate-400 dark:text-slate-500 text-sm pb-8">
                    ...
                    <div className="flex flex-col gap-3 w-full">
                        <button
                            ...
                            className="w-full border-2 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-bold py-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-all"
                        >
                            Usar outro email
                        </button>
                        <button
