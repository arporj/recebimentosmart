...
15. **Ordem Fixa de Modelos Gemini (REGRA ABSOLUTA):** Toda e qualquer chamada à API do Gemini (no backend, server.cjs, netlify functions, admin broadcast, etc.) DEVE seguir OBRIGATORIAMENTE a ordem de prioridade solicitada pelo usuário: `['gemini-3.5-flash', 'gemini-2.5-flash', 'gemini-2.0-flash', 'gemini-1.5-flash']`.
</OUTPUT_INSTRUCTION>
