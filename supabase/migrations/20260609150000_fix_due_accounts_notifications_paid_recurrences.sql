-- =============================================================================
-- Migração: Ajusta o Alerta de Contas para:
--   1. Incluir contas em atraso (vencidas no passado) se existirem.
--   2. Filtrar recorrências mãe (parent_id IS NULL) que já possuem alguma
--      ocorrência filha paga ou cancelada no mesmo período.
-- =============================================================================

-- 1. Redefine a função principal de disparo de e-mails
...
BEGIN
    ...
    LOOP
        ...
        IF v_frequency = 'weekly' THEN
            ...
            -- Verifica se há contas em atraso (pendente no passado, excluindo recorrentes já pagas/canceladas)
            SELECT EXISTS (
                SELECT 1 
                    ...
                    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
                        ...
                        <div style="background-color: #0f172a; padding: 24px; text-align: center; border-bottom: 3px solid #14b8a6;">
                            ...
                            <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.1);">
                                <h1 style="color: #ffffff; margin: 0; font-size: 18px; font-weight: bold; letter-spacing: 0.3px;">' ||
                                CASE WHEN v_has_overdue THEN 'Contas em Atraso'
                                     ELSE 'Seu Resumo Semanal Financeiro'
                                END || '</h1>
...
-- 2. Redefine a função de teste de disparo de e-mails para administradores
