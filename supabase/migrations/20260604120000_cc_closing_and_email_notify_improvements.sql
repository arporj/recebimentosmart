-- Migração: Melhorias no Fechamento de Faturas de Cartão e Notificações de E-mail Personalizadas
-- Data: 04/06/2026

-- 1. Adiciona a coluna de controle do e-mail de fechamento do cartão de crédito à tabela public.profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS card_invoice_email_notify_enabled BOOLEAN DEFAULT TRUE;

COMMENT ON COLUMN public.profiles.card_invoice_email_notify_enabled IS 'Indica se o usuário deseja receber notificações de fechamento da fatura de cartão de crédito';

-- 2. Atualiza os usuários existentes: ativa as notificações e define o dia padrão para semanais (Domingo = 0)
...
UPDATE public.profiles 
SET 
    due_email_notify_day_of_week = 0 
WHERE plano::text = 'basico' OR plano::text = 'free';

-- 3. Atualiza a trigger de criação de novo usuário handle_new_user() para inicializar essas opções ativadas por padrão
...
-- 4. Reescreve a RPC process_due_accounts_notifications() para respeitar as preferências de e-mail do usuário e plano
                    ...
                    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
                        ...
                        <div style="background-color: #0f172a; padding: 24px; text-align: center; border-bottom: 3px solid #14b8a6;">
                            ...
                            <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.1);">
                                <h1 style="color: #ffffff; margin: 0; font-size: 18px; font-weight: bold; letter-spacing: 0.3px;">Seu Resumo Semanal Financeiro</h1>
                    ...
                    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f1f5f9;">
                        <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
                            ...
                            <div style="background-color: #0f172a; padding: 24px; text-align: center; border-bottom: 3px solid #14b8a6;">
                                ...
                                <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.1);">
                                    <h1 style="color: #ffffff; margin: 0; font-size: 18px; font-weight: bold; letter-spacing: 0.3px;">Contas a Vencer Hoje</h1>
                                    <p style="color: #94a3b8; margin: 4px 0 0 0; font-size: 12px;">Acompanhe suas contas pendentes e mantenha seu fluxo saudável</p>
                                </div>
                            </div>
                                ...
                                <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f1f5f9;">
                                    <div style="max-width: 600px; margin: 30px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
                                        ...
                                        <div style="background-color: #0f172a; padding: 24px; text-align: center; border-bottom: 3px solid #14b8a6;">
                                            ...
                                            <div style="margin-top: 16px; padding-top: 16px; border-top: 1px solid rgba(255,255,255,0.1);">
                                                <h1 style="color: #ffffff; margin: 0; font-size: 18px; font-weight: bold; letter-spacing: 0.3px;">Fatura Fechada</h1>
