-- Migration: Adiciona o campo last_sign_in_at à função get_all_users_admin
--
-- Motivo:
-- A página de administração precisa exibir a data do último login de cada usuário.
-- Esta alteração adiciona o campo last_sign_in_at aos dados retornados pela função.
