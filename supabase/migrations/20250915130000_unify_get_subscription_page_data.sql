-- Migration: Unifica a lógica de busca de dados para a página de assinatura.
--
-- Motivo:
-- Combina a lógica de `get_full_referral_stats` com `get_subscription_page_data`
-- para criar uma única fonte de dados para a página de assinatura, melhorando a performance
-- e simplificando a lógica do frontend.
