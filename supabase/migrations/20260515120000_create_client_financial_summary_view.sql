-- Criar View de Resumo Financeiro por Cliente (Netting)
-- Esta view consolida contas a receber e a pagar pendentes para alimentar o novo modulo de recorrencias.
-- Utiliza security_invoker = true para herdar automaticamente as politicas de RLS das tabelas clients e financial_transactions.
...
COMMENT ON VIEW public.client_financial_summary IS 'View consolidada para calculo de saldo liquido (netting) pendente por cliente.';
