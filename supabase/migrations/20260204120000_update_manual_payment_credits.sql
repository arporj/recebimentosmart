-- Migration to update register_manual_payment function with credit deduction logic
-- Created automatically to ensure changes are applied if the previous migration was already run
