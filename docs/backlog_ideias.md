...
#### 1.1.1. 🤝 Novo Sistema de Indicações e Afiliados (Cashback Integral)
...
#### 1.2.1. 💬 Chat de Suporte Administrativo (AdminChatPageV2)
...
#### 1.2.2. 🔔 Sistema de Notificações Mobile (PWA Web Push)
...
#### 1.2.3. 📲 Régua de Cobrança e Notificações via WhatsApp (API Business)
...
#### 1.3.1. 💳 Integração de Cartão de Crédito para Assinaturas
...
#### 1.4.1. 🤖 Artie Full-Control — Cobertura de Todas as Ações do Sistema
...
* **Fora de escopo por ora (não marcar aqui):**
  ...
  * **Lançamentos Compartilhados** (`SharedWithMeV2`) — módulo adiado (ver 1.6.1), não faz sentido automatizar antes da reavaliação de produto.
...
#### 1.5.1. 📊 Relatórios Financeiros Híbridos e DRE (Pessoal + Reembolsos)
...
#### 1.5.2. 📑 Extrato Unificado com Filtros e Badges
...
#### 1.5.3. 🔗 Open Finance e Conciliação Bancária Automática
...
#### 1.5.4. 📁 Gestão de Documentos e Comprovantes
...
#### 1.6.3. ⚙️ Ajuste e Descontos de Pontualidade para Reembolsos
...
#### 1.6.4. 👥 Multi-empresa e Permissões Granulares (RBAC)
...
#### 1.6.5. 📊 Integração Contábil Simplificada para Contadores
...
#### 1.7.2. 🍿 Painel de Controle de Assinaturas Pessoais (Streaming/SaaS)
